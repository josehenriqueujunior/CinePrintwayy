...
namespace CinePrintwayy.Controllers
{
    ...
    public class SalasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,QuantidadeAcentos")] Sala sala)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,QuantidadeAcentos")] Sala sala)
        {
            if (id != sala.Id)
            {
                return NotFound();
